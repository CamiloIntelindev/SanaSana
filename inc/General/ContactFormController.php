 ...
 class ContactFormController extends BaseController
 {
	 ...
	 public function add_assets(){
		...
		$inline_js = "
				...
				const notifyLearnMore = new Notyf({position:{x:'right',y:'top'}, duration: 3000, dismisable: true });
				...
				function showMessageLearnMore(message, error = true) {
					error ?  notifyLearnMore.error(message): notifyLearnMore.success(message)
				}				
                ...
                document.addEventListener('DOMContentLoaded', () => {
                    ...
                    form.addEventListener('submit', async (e) => {
						...
						if (!recaptchaResponse) {
							showMessageLearnMore('".__('Por favor complete la verificación reCAPTCHA.', 'conoce-mas')."');
							return;
						}						
						...
						if(!formObject.PhoneCall && !formObject.WhatsAppMessage){
							showMessageLearnMore('".__('Por favor seleccione al menos un método de contacto.', 'conoce-mas')."');
							return;
						}
						...
						&& !formObject.HealthyChanges						
							...
							showMessageLearnMore('".__('Por favor seleccione al menos una prioridad.', 'conoce-mas')."');
							return;
						}
						setLearnMoreFormDisabled(true);
                        const result = await submitLearnMoreForm(formObject);
						if(result === false){
							showMessageLearnMore('".__('Ha ocurrido un error, intente más tarde', 'conoce-mas')."');
							setLearnMoreFormDisabled(false);
							resetRecaptchaLearnMore();
							return;
						}
						showMessageLearnMore('".__('El mensaje ha sido enviado con éxito', 'conoce-mas')."', false);
						setLearnMoreFormDisabled(false);
						resetLearnMoreForm();
                    });
                });
			...
			<div class="learn-more-form-container">
				<form id="learn-more-form" name="learn-more-form" method="post" action="" novalidate>
					<div class="learn-more-form-fields">
						...
						<!-- -->
						<div class="row">
							<div class="col-lg-6 col-md-6 col-sm-12 learn-more-item">
...
y controles médicos.', 'conoce-mas'); ?></label>
					...
					<div class="learn-more-submit-container">
						<button type="submit" id="submit-button" class="standart-yellow">
